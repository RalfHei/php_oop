<form action="" method="post" class="w-full max-w-sm lg:rounded lg:bg-white lg:overflow-hidden lg:shadow-lg p-4">
  <div class="form-group">
    <h1 class="font-semibold text-2xl tracking-tight text-gray-700 pb-6 lg:px-4"><?php echo $lang['register'] ?></h1>
    ...
    <div class="md:flex md:items-center md:justify-center mb-6">
      <div class="md:w-3/12">
       ...
       md:text-right mb-1 md:mb-0 pr-4" for="inline-passwordRepeat">
          <?php echo $lang['passwordRep'] ?>
        </label>
      </div>
      <div class="md:w-2/3">
        <input value="<?php echo $model->passwordRepeat ?>" class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-indigo-200" id="inline-passwordRepeat" name="passwordRepeat" type="password" placeholder="******************">
        <p class="text-red-500 text-xs italic"><?php echo $model->getFirstError('passwordRepeat') ?></p>
      </div>
    </div>
    ...
    <div class="w-full md:flex md:items-center md:justify-center mb-6">
      <h3 class="text-gray-500 mr-2">
        <?php echo $lang['accountText'] ?>
      </h3>
      <a class="inline-block align-baseline font-bold 
    text-sm text-indigo-500 hover:text-indigo-300" href="/login">
        <?php echo $lang['login'] ?>
      </a>
    </div>
  </div>
